...
import com.anthem.rostertracker.service.RAProviderService;
...
import static com.anthem.rostertracker.service.RAProviderService.DEFAULT_NO_OF_ENTRIES;
import static com.anthem.rostertracker.utils.Utils.removeDuplicatesFromList;
...
public class RAProviderController {
    ...
    public ResponseEntity<List<RAProvDetails>> getRAProvListFromProviderSearchStr(@RequestParam(defaultValue = "") String searchStr) {
        try {
            ...
            if (searchStr == null || searchStr.isEmpty()) {
                raProvDetails = raProviderService.findTopEntriesOrderBySourceName(DEFAULT_NO_OF_ENTRIES);
            } else {
    ...
    public ResponseEntity<List<String>> getAllLineOfBusiness() {
        try {
            ...
            flattenedList = removeDuplicatesFromList(flattenedList);
