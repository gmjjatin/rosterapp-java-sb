...
import com.anthem.rostertracker.repository.RAProvDetailsRepository;
...
import static com.anthem.rostertracker.utils.RosterUtils.removeDuplicateRAProvList;
...
//    }
    ...
    public List<RAProvDetails> getRAProvListFromSearchStr(String searchStr) {
        ...
        return removeDuplicateRAProvList(allRAProvDetailsList);
    }
}
